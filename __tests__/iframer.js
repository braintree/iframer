...
describe('iframer', () => {
  ...
  describe('style', () => {
    it('applies styles as a string', () => {
      const result = iframer({style: 'background: tomato; transition: color 100ms;'});

      expect(result.getAttribute('style')).toBe('background: tomato; transition: color 100ms;');
    });
